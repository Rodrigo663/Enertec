...
},{}],"../../node_modules/email-validator/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"send.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 201) {
              (0, _alert.showAlert)('success', 'O seu pedido foi enviado', 3000);
...
var bigForm = $('.big-form');

if (bigForm.length) {
  var _button = $('.btn--green');

  var interest;
  var object;
  var regex = '^(?:0|\\(?\\+4[0-9]\\)?\s?|0033\\s?)[1-79](?:[-.\\s]?\\d\\d){4}$';

  _button.on('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!(EmailValidator.validate($('.big-form__email').val()) && $('.big-form__name').val().length > 3 && $('.big-form__last-name').val().length > 3 && document.querySelector('.big-form__cellphone').checkValidity())) {
                _context.next = 11;
                break;
              }

              e.preventDefault();
              radio1 = $('#exampleRadios1').is(':checked');
              radio2 = $('#exampleRadios2').is(':checked');
              object = {
              ...
              _button.text('Enviando...');

              _context.next = 8;
              return (0, _send.sendData)(object);
